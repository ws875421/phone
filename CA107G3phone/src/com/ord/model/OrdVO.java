...
public class OrdVO implements java.io.Serializable {
	...
	public String toString() {
		return "OrdVO [ord_no=" + ord_no + ", mem_no=" + mem_no + ", vendor_no=" + vendor_no + ", tbl_no=" + tbl_no
				+ ", party_size=" + party_size + ", share_mem_no1=" + share_mem_no1 + ", share_mem_no2=" + share_mem_no2
				+ ", share_amount=" + share_amount + ", ord_time=" + ord_time + ", booking_date=" + booking_date
				+ ", booking_time=" + booking_time + ", notes=" + notes + ", total=" + total + ", arrival_time="
				+ arrival_time + ", finish_time=" + finish_time + ", verif_code=" + verif_code + ", status=" + status
				+ "]";
	}
